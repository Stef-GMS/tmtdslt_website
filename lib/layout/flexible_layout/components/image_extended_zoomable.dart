...
@client
class ZoomableImageExtended extends StatefulComponent {
  ZoomableImageExtended({
    required this.src,
    this.alt,
    this.caption,
    this.title,
  ...
  @override
  State<StatefulComponent> createState() => _ZoomableImageExtendedState();
...
class _ZoomableImageExtendedState extends State<ZoomableImageExtended> with ViewTransitionMixin {
